<template>
  <div id="deposit" style="background:white">
    ...
    <el-row :gutter="20">
      <el-col :span="12"
        ><div class="grid-content margin1">
          <div class="money">
            <span>微信转账</span>
      ...
      <el-col :span="12"
        ><div class="grid-content margin1">
          <div style="margin-left:20px">
            ...
            <div class="cell">
              <span class="cellTitle1"
                >（恶意提交、未打款后提交，将罚款100/次，甚至封号）</span
              >
            </div>
            ...
            <div class="cell">
              <span class="cellTitle"
                >为提高审核速度，可选提交截图（截图要求：清晰看到打款时间和转账金额）</span
              >
            </div>
      ...
      <el-col :span="12"
        ><div class="grid-content margin1">
          <div style="margin-left:20px">
            <div class="cell">
              <span class="cellTitle"
                >充值客服工作时间每日9：30-18：00，审核人员每15分钟会审核一次，查询到账即能通过审核，18:00以后的
                银行卡转账充值将无人审核，会到第二个工作日处理</span
              >
            </div>
          </div>
        </div></el-col
