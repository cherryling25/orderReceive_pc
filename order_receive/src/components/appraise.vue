      ...
      <el-main>
        ...
        >
          ...
          <el-table-column fixed="right" label="操作" width="120">
            <template slot-scope="scope">
              <el-button
                @click.native.prevent="appraise(scope.row.id)"
                type="success"
                plain
                size="small"
              >
    ...
    >
      <el-form :model="dialogForm">
        <el-form-item label="图片" label-width="100px">
          ...
          >
            <img v-if="dialogForm.pic" :src="dialogForm.pic" class="avatar" />
...
export default {
  ...
  methods: {
    ...
    console.log(this.id)
          ...
          data: Qs.stringify({
            id: this.id,
            image: this.dialogForm.pic1
          }),
          url: this.GLOBAL.hostUrl5 + "admin/Order/order_shua_pj"
        }).then(res => {
          console.log(res);
